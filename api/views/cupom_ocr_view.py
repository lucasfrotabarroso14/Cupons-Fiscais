...
from ..services.cupons_ocr_service import get_cupons_pendentes_ocr, post_ocr
from ..utils.Serialize import Serialize

cupons_ocr_swagger = Namespace('cupons/ocr', description='Endpoints para o serviço de OCR')
...
class CuponsPendentesOCR(Resource):
    ...
    def post(self):
        ...
        if not bandeira_cartao or not forma_de_pagamento or not imagem:
            response_data = {
                "status_code": 404,
                "status": False,
